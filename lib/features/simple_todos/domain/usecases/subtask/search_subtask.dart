...
/// Use case for searching Subtask entities with text queries.
///
/// This use case handles the business logic for performing text-based
/// searches across Subtask entities.
/// Returns Either&lt;Failure, List&lt;SubtaskEntity&gt;&gt; for functional error handling.
class SearchSubtasksUseCase extends BaseUseCase<List<SubtaskEntity>, SearchParams> {
  final SubtaskRepository repository;

  SearchSubtasksUseCase(this.repository);

  @override
  Future<Either<Failure, List<SubtaskEntity>>> call(SearchParams params) async {
...
if (params.query.trim().isEmpty) {
      ...
      return Left(UnknownFailure('Failed to search Subtasks: ${e.toString()}', e));
    }
  }
}
