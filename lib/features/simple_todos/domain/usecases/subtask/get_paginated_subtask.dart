...
/// Use case for retrieving paginated Subtask entities.
///
...
class GetPaginatedSubtasksUseCase extends BaseUseCase<List<SubtaskEntity>, PaginationParams> {
  final SubtaskRepository repository;

  GetPaginatedSubtasksUseCase(this.repository);

  @override
  Future<Either<Failure, List<SubtaskEntity>>> call(PaginationParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get paginated Subtasks: ${e.toString()}', e));
    }
  }
}
