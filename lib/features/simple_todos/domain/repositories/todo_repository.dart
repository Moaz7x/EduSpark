...
/// Repository interface for Todo entities following Clean Architecture principles.
///
...
abstract class TodoRepository {
  ...
  /// Creates a new Todo entity in the data source.
  ///
  /// [entity] The Todo entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, TodoEntity>> create(TodoEntity entity);

  /// Retrieves a Todo entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, TodoEntity?>> getById(int id);

  /// Retrieves all Todo entities from the data source.
  ///
  ...
  /// Updates an existing Todo entity in the data source.
  ///
  /// [entity] The Todo entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, TodoEntity>> update(TodoEntity entity);

  /// Deletes a Todo entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<TodoEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<TodoEntity>>> search(String query);
  ...
  Future<Either<Failure, List<TodoEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<TodoEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, TodoEntity>> loadWithRelationships(TodoEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(TodoEntity entity, {List<dynamic>? childEntities});
