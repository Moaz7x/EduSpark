...
/// Repository interface for Reminder entities following Clean Architecture principles.
///
...
abstract class ReminderRepository {
  ...
  /// Creates a new Reminder entity in the data source.
  ///
  /// [entity] The Reminder entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, ReminderEntity>> create(ReminderEntity entity);

  /// Retrieves a Reminder entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, ReminderEntity?>> getById(int id);

  /// Retrieves all Reminder entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ReminderEntity>>> getAll();

  /// Updates an existing Reminder entity in the data source.
  ///
  /// [entity] The Reminder entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, ReminderEntity>> update(ReminderEntity entity);

  /// Deletes a Reminder entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<ReminderEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ReminderEntity>>> search(String query);
  ...
  Future<Either<Failure, List<ReminderEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<ReminderEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, ReminderEntity>> loadWithRelationships(ReminderEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(ReminderEntity entity, {List<dynamic>? childEntities});
