...
/// Repository implementation for Subtask feature.
///
...
class SubtaskRepositoryImpl implements SubtaskRepository {
  ...
  SubtaskRepositoryImpl(this.localDataSource);

  static const String _entityType = 'subtask';

  @override
  Future<Either<Failure, SubtaskEntity>> create(SubtaskEntity entity) async {
    try {
      final model = SubtaskModel.fromEntity(entity);
      final result = await localDataSource.create<SubtaskModel>(model);
      return result.fold(
  ...
  @override
  Future<Either<Failure, SubtaskEntity?>> getById(int id) async {
    try {
      final result = await localDataSource.getById<SubtaskModel>(id, _entityType);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, List<SubtaskEntity>>> getAll() async {
    try {
      final result = await localDataSource.getAll<SubtaskModel>(_entityType);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, SubtaskEntity>> update(SubtaskEntity entity) async {
    try {
      final model = SubtaskModel.fromEntity(entity);
      final result = await localDataSource.update<SubtaskModel>(model);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, List<SubtaskEntity>>> getByField(
      String fieldName, dynamic value) async {
    try {
      final filters = {fieldName: value};
      final result =
          await localDataSource.getFiltered<SubtaskModel>(filters, _entityType);
      return result.fold(
        (failure) => Left(failure),
        (models) => Right(models.map((model) => model.toEntity()).toList()),
      );
  ...
  @override
  Future<Either<Failure, List<SubtaskEntity>>> search(String query) async {
    try {
      final result =
          await localDataSource.search<SubtaskModel>(query, _entityType);
      return result.fold(
        (failure) => Left(failure),
        (models) => Right(models.map((model) => model.toEntity()).toList()),
      );
  ...
  @override
  Future<Either<Failure, List<SubtaskEntity>>> getPaginated(
      int page, int limit) async {
    try {
      final result = await localDataSource.getPaginated<SubtaskModel>(
  ...
  @override
  Future<Either<Failure, List<SubtaskEntity>>> getFiltered(
  ...
  Future<Either<Failure, SubtaskEntity>> loadWithRelationships(
      SubtaskEntity entity) async {
    try {
      final model = SubtaskModel.fromEntity(entity);
      final result =
  ...
  Future<Either<Failure, bool>> saveWithRelationships(SubtaskEntity entity,
