...
/// Repository implementation for Review feature.
///
...
class ReviewRepositoryImpl implements ReviewRepository {
  ...
  static const String _entityType = 'review';

  @override
  Future<Either<Failure, ReviewEntity>> create(ReviewEntity entity) async {
    try {
      final model = ReviewModel.fromEntity(entity);
      final result = await localDataSource.create<ReviewModel>(model);
      return result.fold(
  ...
  @override
  Future<Either<Failure, ReviewEntity?>> getById(int id) async {
    try {
      final result = await localDataSource.getById<ReviewModel>(id, _entityType);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, List<ReviewEntity>>> getAll() async {
    try {
      final result = await localDataSource.getAll<ReviewModel>(_entityType);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, ReviewEntity>> update(ReviewEntity entity) async {
    try {
      final model = ReviewModel.fromEntity(entity);
      final result = await localDataSource.update<ReviewModel>(model);
      return result.fold(
        (failure) => Left(failure),
  ...
  @override
  Future<Either<Failure, List<ReviewEntity>>> getByField(
      String fieldName, dynamic value) async {
    try {
      final filters = {fieldName: value};
      final result =
          await localDataSource.getFiltered<ReviewModel>(filters, _entityType);
      return result.fold(
        (failure) => Left(failure),
        (models) => Right(models.map((model) => model.toEntity()).toList()),
      );
  ...
  @override
  Future<Either<Failure, List<ReviewEntity>>> search(String query) async {
    try {
      final result =
          await localDataSource.search<ReviewModel>(query, _entityType);
      return result.fold(
        (failure) => Left(failure),
        (models) => Right(models.map((model) => model.toEntity()).toList()),
      );
  ...
  @override
  Future<Either<Failure, List<ReviewEntity>>> getPaginated(
      int page, int limit) async {
    try {
      final result = await localDataSource.getPaginated<ReviewModel>(
  ...
  @override
  Future<Either<Failure, List<ReviewEntity>>> getFiltered(
  ...
  Future<Either<Failure, ReviewEntity>> loadWithRelationships(
  ...
  Future<Either<Failure, bool>> saveWithRelationships(ReviewEntity entity,
