...
/// Use case for retrieving filtered Flashcard entities.
///
...
class GetFilteredFlashcardsUseCase extends BaseUseCase<List<FlashcardEntity>, FilterParams> {
  final FlashcardRepository repository;

  GetFilteredFlashcardsUseCase(this.repository);

  @override
  Future<Either<Failure, List<FlashcardEntity>>> call(FilterParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get filtered Flashcards: ${e.toString()}', e));
    }
  }
}
