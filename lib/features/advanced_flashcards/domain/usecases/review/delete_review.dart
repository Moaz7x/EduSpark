...
/// Use case for deleting a Review entity.
///
/// This use case handles the business logic for removing a Review
/// entity from the system.
/// Returns Either&lt;Failure, bool&gt; for functional error handling.
class DeleteReviewUseCase extends BaseUseCase<bool, IdParams> {
    ...
    try {
      ...
      return existsResult.fold(
        ...
        (exists) {
          if (!exists) {
            return Left(
                ValidationFailure('Review with ID ${params.id} does not exist'));
          }
      ...
      return Left(UnknownFailure('Failed to delete Review: ${e.toString()}', e));
    }
  }
