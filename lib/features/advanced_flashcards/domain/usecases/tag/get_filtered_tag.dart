...
/// Use case for retrieving filtered Tag entities.
///
...
class GetFilteredTagsUseCase extends BaseUseCase<List<TagEntity>, FilterParams> {
  final TagRepository repository;

  GetFilteredTagsUseCase(this.repository);

  @override
  Future<Either<Failure, List<TagEntity>>> call(FilterParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get filtered Tags: ${e.toString()}', e));
    }
  }
}
