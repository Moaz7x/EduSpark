...
/// Use case for searching Deck entities with text queries.
///
/// This use case handles the business logic for performing text-based
/// searches across Deck entities.
/// Returns Either&lt;Failure, List&lt;DeckEntity&gt;&gt; for functional error handling.
class SearchDecksUseCase extends BaseUseCase<List<DeckEntity>, SearchParams> {
  final DeckRepository repository;

  SearchDecksUseCase(this.repository);

  @override
  Future<Either<Failure, List<DeckEntity>>> call(SearchParams params) async {
...
if (params.query.trim().isEmpty) {
      ...
      return Left(UnknownFailure('Failed to search Decks: ${e.toString()}', e));
    }
  }
}
