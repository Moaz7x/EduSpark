...
/// Repository interface for Media entities following Clean Architecture principles.
///
...
abstract class MediaRepository {
  ...
  /// Creates a new Media entity in the data source.
  ///
  /// [entity] The Media entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, MediaEntity>> create(MediaEntity entity);
  ...
  Future<Either<Failure, MediaEntity?>> getById(int id);

  /// Retrieves all Media entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<MediaEntity>>> getAll();

  /// Updates an existing Media entity in the data source.
  ///
  /// [entity] The Media entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, MediaEntity>> update(MediaEntity entity);

  /// Deletes a Media entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<MediaEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<MediaEntity>>> search(String query);
  ...
  Future<Either<Failure, List<MediaEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<MediaEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, MediaEntity>> loadWithRelationships(MediaEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(MediaEntity entity, {List<dynamic>? childEntities});
