...
/// Repository interface for Tag entities following Clean Architecture principles.
///
...
abstract class TagRepository {
  ...
  /// Creates a new Tag entity in the data source.
  ///
  /// [entity] The Tag entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, TagEntity>> create(TagEntity entity);

  /// Retrieves a Tag entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, TagEntity?>> getById(int id);

  /// Retrieves all Tag entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<TagEntity>>> getAll();

  /// Updates an existing Tag entity in the data source.
  ///
  /// [entity] The Tag entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, TagEntity>> update(TagEntity entity);

  /// Deletes a Tag entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<TagEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<TagEntity>>> search(String query);
  ...
  Future<Either<Failure, List<TagEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<TagEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, TagEntity>> loadWithRelationships(TagEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(TagEntity entity, {List<dynamic>? childEntities});
