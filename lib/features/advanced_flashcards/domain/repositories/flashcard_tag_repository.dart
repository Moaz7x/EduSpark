...
/// Repository interface for FlashcardTag entities following Clean Architecture principles.
///
...
abstract class FlashcardTagRepository {

  // ==================== CRUD Operations ====================

  /// Creates a new FlashcardTag entity in the data source.
  ///
  /// [entity] The FlashcardTag entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, FlashcardTagEntity>> create(FlashcardTagEntity entity);

  /// Retrieves a FlashcardTag entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, FlashcardTagEntity?>> getById(int id);

  /// Retrieves all FlashcardTag entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<FlashcardTagEntity>>> getAll();

  /// Updates an existing FlashcardTag entity in the data source.
  ///
  /// [entity] The FlashcardTag entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, FlashcardTagEntity>> update(FlashcardTagEntity entity);

  /// Deletes a FlashcardTag entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<FlashcardTagEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<FlashcardTagEntity>>> search(String query);
  ...
  Future<Either<Failure, List<FlashcardTagEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<FlashcardTagEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, FlashcardTagEntity>> loadWithRelationships(FlashcardTagEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(FlashcardTagEntity entity, {List<dynamic>? childEntities});
