...
/// Repository interface for Review entities following Clean Architecture principles.
///
...
abstract class ReviewRepository {
  ...
  /// Creates a new Review entity in the data source.
  ///
  /// [entity] The Review entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, ReviewEntity>> create(ReviewEntity entity);

  /// Retrieves a Review entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, ReviewEntity?>> getById(int id);

  /// Retrieves all Review entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ReviewEntity>>> getAll();

  /// Updates an existing Review entity in the data source.
  ///
  /// [entity] The Review entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, ReviewEntity>> update(ReviewEntity entity);
  ...
  Future<Either<Failure, List<ReviewEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ReviewEntity>>> search(String query);
  ...
  Future<Either<Failure, List<ReviewEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<ReviewEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, ReviewEntity>> loadWithRelationships(ReviewEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(ReviewEntity entity, {List<dynamic>? childEntities});
