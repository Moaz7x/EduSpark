...
/// Repository interface for Flashcard entities following Clean Architecture principles.
///
...
abstract class FlashcardRepository {
  ...
  /// Creates a new Flashcard entity in the data source.
  ///
  /// [entity] The Flashcard entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, FlashcardEntity>> create(FlashcardEntity entity);

  /// Retrieves a Flashcard entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, FlashcardEntity?>> getById(int id);

  /// Retrieves all Flashcard entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<FlashcardEntity>>> getAll();

  /// Updates an existing Flashcard entity in the data source.
  ///
  /// [entity] The Flashcard entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, FlashcardEntity>> update(FlashcardEntity entity);

  /// Deletes a Flashcard entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<FlashcardEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<FlashcardEntity>>> search(String query);
  ...
  Future<Either<Failure, List<FlashcardEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<FlashcardEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, FlashcardEntity>> loadWithRelationships(FlashcardEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(FlashcardEntity entity, {List<dynamic>? childEntities});
