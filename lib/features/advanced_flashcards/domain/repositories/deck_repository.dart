...
/// Repository interface for Deck entities following Clean Architecture principles.
///
...
abstract class DeckRepository {
  ...
  /// Creates a new Deck entity in the data source.
  ///
  /// [entity] The Deck entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, DeckEntity>> create(DeckEntity entity);

  /// Retrieves a Deck entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, DeckEntity?>> getById(int id);

  /// Retrieves all Deck entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<DeckEntity>>> getAll();

  /// Updates an existing Deck entity in the data source.
  ///
  /// [entity] The Deck entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, DeckEntity>> update(DeckEntity entity);

  /// Deletes a Deck entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<DeckEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<DeckEntity>>> search(String query);
  ...
  Future<Either<Failure, List<DeckEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<DeckEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, DeckEntity>> loadWithRelationships(DeckEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(DeckEntity entity, {List<dynamic>? childEntities});
