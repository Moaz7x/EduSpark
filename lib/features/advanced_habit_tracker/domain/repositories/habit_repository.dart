...
/// Repository interface for Habit entities following Clean Architecture principles.
///
...
abstract class HabitRepository {
  ...
  /// Creates a new Habit entity in the data source.
  ///
  /// [entity] The Habit entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, HabitEntity>> create(HabitEntity entity);

  /// Retrieves a Habit entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, HabitEntity?>> getById(int id);

  /// Retrieves all Habit entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitEntity>>> getAll();

  /// Updates an existing Habit entity in the data source.
  ///
  /// [entity] The Habit entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, HabitEntity>> update(HabitEntity entity);

  /// Deletes a Habit entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<HabitEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitEntity>>> search(String query);
  ...
  Future<Either<Failure, List<HabitEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<HabitEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, HabitEntity>> loadWithRelationships(HabitEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(HabitEntity entity, {List<dynamic>? childEntities});
