...
/// Repository interface for HabitReminder entities following Clean Architecture principles.
///
...
abstract class HabitReminderRepository {
  ...
  /// Creates a new HabitReminder entity in the data source.
  ///
  /// [entity] The HabitReminder entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, HabitReminderEntity>> create(HabitReminderEntity entity);

  /// Retrieves a HabitReminder entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, HabitReminderEntity?>> getById(int id);

  /// Retrieves all HabitReminder entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitReminderEntity>>> getAll();

  /// Updates an existing HabitReminder entity in the data source.
  ///
  /// [entity] The HabitReminder entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, HabitReminderEntity>> update(HabitReminderEntity entity);

  /// Deletes a HabitReminder entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<HabitReminderEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitReminderEntity>>> search(String query);
  ...
  Future<Either<Failure, List<HabitReminderEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<HabitReminderEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, HabitReminderEntity>> loadWithRelationships(HabitReminderEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(HabitReminderEntity entity, {List<dynamic>? childEntities});
