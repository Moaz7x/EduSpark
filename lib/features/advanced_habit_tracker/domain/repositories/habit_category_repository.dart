...
/// Repository interface for HabitCategory entities following Clean Architecture principles.
///
...
abstract class HabitCategoryRepository {
  ...
  /// Creates a new HabitCategory entity in the data source.
  ///
  /// [entity] The HabitCategory entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, HabitCategoryEntity>> create(HabitCategoryEntity entity);

  /// Retrieves a HabitCategory entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, HabitCategoryEntity?>> getById(int id);

  /// Retrieves all HabitCategory entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitCategoryEntity>>> getAll();

  /// Updates an existing HabitCategory entity in the data source.
  ///
  /// [entity] The HabitCategory entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, HabitCategoryEntity>> update(HabitCategoryEntity entity);

  /// Deletes a HabitCategory entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<HabitCategoryEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitCategoryEntity>>> search(String query);
  ...
  Future<Either<Failure, List<HabitCategoryEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<HabitCategoryEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, HabitCategoryEntity>> loadWithRelationships(HabitCategoryEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(HabitCategoryEntity entity, {List<dynamic>? childEntities});
