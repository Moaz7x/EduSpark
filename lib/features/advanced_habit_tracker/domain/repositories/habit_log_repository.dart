...
/// Repository interface for HabitLog entities following Clean Architecture principles.
///
...
abstract class HabitLogRepository {
  ...
  /// Creates a new HabitLog entity in the data source.
  ///
  /// [entity] The HabitLog entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, HabitLogEntity>> create(HabitLogEntity entity);

  /// Retrieves a HabitLog entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, HabitLogEntity?>> getById(int id);

  /// Retrieves all HabitLog entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitLogEntity>>> getAll();

  /// Updates an existing HabitLog entity in the data source.
  ///
  /// [entity] The HabitLog entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, HabitLogEntity>> update(HabitLogEntity entity);

  /// Deletes a HabitLog entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<HabitLogEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<HabitLogEntity>>> search(String query);
  ...
  Future<Either<Failure, List<HabitLogEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<HabitLogEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, HabitLogEntity>> loadWithRelationships(HabitLogEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(HabitLogEntity entity, {List<dynamic>? childEntities});
