...
/// Repository interface for TextExtractionJob entities following Clean Architecture principles.
///
...
abstract class TextExtractionJobRepository {

  // ==================== CRUD Operations ====================

  /// Creates a new TextExtractionJob entity in the data source.
  ///
  /// [entity] The TextExtractionJob entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, TextExtractionJobEntity>> create(TextExtractionJobEntity entity);

  /// Retrieves a TextExtractionJob entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, TextExtractionJobEntity?>> getById(int id);

  /// Retrieves all TextExtractionJob entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<TextExtractionJobEntity>>> getAll();

  /// Updates an existing TextExtractionJob entity in the data source.
  ///
  /// [entity] The TextExtractionJob entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, TextExtractionJobEntity>> update(TextExtractionJobEntity entity);

  /// Deletes a TextExtractionJob entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<TextExtractionJobEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<TextExtractionJobEntity>>> search(String query);
  ...
  Future<Either<Failure, List<TextExtractionJobEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<TextExtractionJobEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, TextExtractionJobEntity>> loadWithRelationships(TextExtractionJobEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(TextExtractionJobEntity entity, {List<dynamic>? childEntities});
