...
/// Repository interface for MediaSource entities following Clean Architecture principles.
///
...
abstract class MediaSourceRepository {
  ...
  /// Creates a new MediaSource entity in the data source.
  ///
  /// [entity] The MediaSource entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, MediaSourceEntity>> create(MediaSourceEntity entity);

  /// Retrieves a MediaSource entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, MediaSourceEntity?>> getById(int id);

  /// Retrieves all MediaSource entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<MediaSourceEntity>>> getAll();

  /// Updates an existing MediaSource entity in the data source.
  ///
  /// [entity] The MediaSource entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, MediaSourceEntity>> update(MediaSourceEntity entity);

  /// Deletes a MediaSource entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<MediaSourceEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<MediaSourceEntity>>> search(String query);
  ...
  Future<Either<Failure, List<MediaSourceEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<MediaSourceEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, MediaSourceEntity>> loadWithRelationships(MediaSourceEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(MediaSourceEntity entity, {List<dynamic>? childEntities});
