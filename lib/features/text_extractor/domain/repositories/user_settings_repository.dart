...
/// Repository interface for UserSettings entities following Clean Architecture principles.
///
...
abstract class UserSettingsRepository {
  ...
  /// Creates a new UserSettings entity in the data source.
  ///
  /// [entity] The UserSettings entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, UserSettingsEntity>> create(UserSettingsEntity entity);

  /// Retrieves a UserSettings entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, UserSettingsEntity?>> getById(int id);

  /// Retrieves all UserSettings entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<UserSettingsEntity>>> getAll();

  /// Updates an existing UserSettings entity in the data source.
  ///
  /// [entity] The UserSettings entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, UserSettingsEntity>> update(UserSettingsEntity entity);

  /// Deletes a UserSettings entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<UserSettingsEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<UserSettingsEntity>>> search(String query);
  ...
  Future<Either<Failure, List<UserSettingsEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<UserSettingsEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, UserSettingsEntity>> loadWithRelationships(UserSettingsEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(UserSettingsEntity entity, {List<dynamic>? childEntities});
