...
/// Repository interface for ExtractedText entities following Clean Architecture principles.
///
...
abstract class ExtractedTextRepository {

  // ==================== CRUD Operations ====================

  /// Creates a new ExtractedText entity in the data source.
  ///
  /// [entity] The ExtractedText entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, ExtractedTextEntity>> create(ExtractedTextEntity entity);

  /// Retrieves a ExtractedText entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, ExtractedTextEntity?>> getById(int id);

  /// Retrieves all ExtractedText entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ExtractedTextEntity>>> getAll();

  /// Updates an existing ExtractedText entity in the data source.
  ///
  /// [entity] The ExtractedText entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, ExtractedTextEntity>> update(ExtractedTextEntity entity);

  /// Deletes a ExtractedText entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<ExtractedTextEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<ExtractedTextEntity>>> search(String query);
  ...
  Future<Either<Failure, List<ExtractedTextEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<ExtractedTextEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, ExtractedTextEntity>> loadWithRelationships(ExtractedTextEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(ExtractedTextEntity entity, {List<dynamic>? childEntities});
