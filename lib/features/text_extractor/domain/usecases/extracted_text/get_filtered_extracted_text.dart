...
/// Use case for retrieving filtered ExtractedText entities.
///
...
class GetFilteredExtractedTextsUseCase extends BaseUseCase<List<ExtractedTextEntity>, FilterParams> {
  final ExtractedTextRepository repository;

  GetFilteredExtractedTextsUseCase(this.repository);

  @override
  Future<Either<Failure, List<ExtractedTextEntity>>> call(FilterParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get filtered ExtractedTexts: ${e.toString()}', e));
    }
  }
}
