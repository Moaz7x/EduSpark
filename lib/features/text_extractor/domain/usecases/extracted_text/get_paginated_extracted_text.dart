...
/// Use case for retrieving paginated ExtractedText entities.
///
/// This use case handles the business logic for fetching ExtractedText entities
...
class GetPaginatedExtractedTextsUseCase extends BaseUseCase<List<ExtractedTextEntity>, PaginationParams> {
  final ExtractedTextRepository repository;

  GetPaginatedExtractedTextsUseCase(this.repository);

  @override
  Future<Either<Failure, List<ExtractedTextEntity>>> call(PaginationParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get paginated ExtractedTexts: ${e.toString()}', e));
    }
  }
}
