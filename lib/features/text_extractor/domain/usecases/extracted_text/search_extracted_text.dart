...
/// Use case for searching ExtractedText entities with text queries.
///
/// This use case handles the business logic for performing text-based
/// searches across ExtractedText entities.
/// Returns Either&lt;Failure, List&lt;ExtractedTextEntity&gt;&gt; for functional error handling.
class SearchExtractedTextsUseCase extends BaseUseCase<List<ExtractedTextEntity>, SearchParams> {
  final ExtractedTextRepository repository;

  SearchExtractedTextsUseCase(this.repository);

  @override
  Future<Either<Failure, List<ExtractedTextEntity>>> call(SearchParams params) async {
...
if (params.query.trim().isEmpty) {
      ...
      return Left(UnknownFailure('Failed to search ExtractedTexts: ${e.toString()}', e));
    }
  }
}
