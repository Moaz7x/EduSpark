...
/// Use case for deleting a Statistics entity.
///
/// This use case handles the business logic for removing a Statistics
/// entity from the system.
/// Returns Either&lt;Failure, bool&gt; for functional error handling.
class DeleteStatisticsUseCase extends BaseUseCase<bool, IdParams> {
  final StatisticsRepository repository;

  DeleteStatisticsUseCase(this.repository);
    ...
    try {
      ...
      return existsResult.fold(
        ...
        (exists) {
          if (!exists) {
            return Left(
                ValidationFailure('Statistics with ID ${params.id} does not exist'));
          }
      ...
      return Left(UnknownFailure('Failed to delete Statistics: ${e.toString()}', e));
    }
  }
