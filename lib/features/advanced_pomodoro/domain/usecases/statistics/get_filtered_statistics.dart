...
/// Use case for retrieving filtered Statistics entities.
///
...
class GetFilteredStatisticssUseCase extends BaseUseCase<List<StatisticsEntity>, FilterParams> {
  final StatisticsRepository repository;

  GetFilteredStatisticssUseCase(this.repository);

  @override
  Future<Either<Failure, List<StatisticsEntity>>> call(FilterParams params) async {
    ...
    if (params.filters.isEmpty) {
      try {
        ...
        return Left(UnknownFailure('Failed to get all Statisticss: ${e.toString()}', e));
      }
    }
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get filtered Statisticss: ${e.toString()}', e));
    }
  }
}
