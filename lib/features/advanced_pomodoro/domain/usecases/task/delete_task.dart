...
/// Use case for deleting a Task entity.
///
/// This use case handles the business logic for removing a Task
/// entity from the system.
/// Returns Either&lt;Failure, bool&gt; for functional error handling.
class DeleteTaskUseCase extends BaseUseCase<bool, IdParams> {
    ...
    try {
      ...
      return existsResult.fold(
        ...
        (exists) {
          if (!exists) {
            return Left(
                ValidationFailure('Task with ID ${params.id} does not exist'));
          }
      ...
      return Left(UnknownFailure('Failed to delete Task: ${e.toString()}', e));
    }
  }
