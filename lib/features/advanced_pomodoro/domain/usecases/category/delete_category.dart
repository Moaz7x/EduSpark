...
/// Use case for deleting a Category entity.
///
/// This use case handles the business logic for removing a Category
/// entity from the system.
/// Returns Either&lt;Failure, bool&gt; for functional error handling.
class DeleteCategoryUseCase extends BaseUseCase<bool, IdParams> {
    ...
    try {
      ...
      return existsResult.fold(
        ...
        (exists) {
          if (!exists) {
            return Left(
                ValidationFailure('Category with ID ${params.id} does not exist'));
          }
      ...
      return Left(UnknownFailure('Failed to delete Category: ${e.toString()}', e));
    }
  }
