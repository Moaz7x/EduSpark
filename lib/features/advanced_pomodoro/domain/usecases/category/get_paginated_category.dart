...
/// Use case for retrieving paginated Category entities.
///
...
class GetPaginatedCategorysUseCase extends BaseUseCase<List<CategoryEntity>, PaginationParams> {
  final CategoryRepository repository;

  GetPaginatedCategorysUseCase(this.repository);

  @override
  Future<Either<Failure, List<CategoryEntity>>> call(PaginationParams params) async {
    ...
    try {
      ...
      return Left(UnknownFailure('Failed to get paginated Categorys: ${e.toString()}', e));
    }
  }
}
