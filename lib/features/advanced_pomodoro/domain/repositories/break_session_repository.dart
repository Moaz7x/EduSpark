...
/// Repository interface for BreakSession entities following Clean Architecture principles.
///
...
abstract class BreakSessionRepository {

  // ==================== CRUD Operations ====================

  /// Creates a new BreakSession entity in the data source.
  ///
  /// [entity] The BreakSession entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, BreakSessionEntity>> create(BreakSessionEntity entity);

  /// Retrieves a BreakSession entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, BreakSessionEntity?>> getById(int id);

  /// Retrieves all BreakSession entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<BreakSessionEntity>>> getAll();

  /// Updates an existing BreakSession entity in the data source.
  ///
  /// [entity] The BreakSession entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, BreakSessionEntity>> update(BreakSessionEntity entity);

  /// Deletes a BreakSession entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<BreakSessionEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<BreakSessionEntity>>> search(String query);
  ...
  Future<Either<Failure, List<BreakSessionEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<BreakSessionEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, BreakSessionEntity>> loadWithRelationships(BreakSessionEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(BreakSessionEntity entity, {List<dynamic>? childEntities});
