...
/// Repository interface for Task entities following Clean Architecture principles.
///
...
abstract class TaskRepository {
  ...
  /// Retrieves all Task entities from the data source.
  ///
  ...
  ///
  /// [entity] The Task entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, TaskEntity>> update(TaskEntity entity);

  /// Deletes a Task entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<TaskEntity>>> getByField(String fieldName, dynamic value);
  ...
  Future<Either<Failure, List<TaskEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<TaskEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, TaskEntity>> loadWithRelationships(TaskEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(TaskEntity entity, {List<dynamic>? childEntities});
