...
/// Repository interface for Statistics entities following Clean Architecture principles.
///
...
abstract class StatisticsRepository {
  ...
  /// Creates a new Statistics entity in the data source.
  ///
  /// [entity] The Statistics entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, StatisticsEntity>> create(StatisticsEntity entity);

  /// Retrieves a Statistics entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, StatisticsEntity?>> getById(int id);

  /// Retrieves all Statistics entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<StatisticsEntity>>> getAll();

  /// Updates an existing Statistics entity in the data source.
  ///
  /// [entity] The Statistics entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, StatisticsEntity>> update(StatisticsEntity entity);

  /// Deletes a Statistics entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<StatisticsEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<StatisticsEntity>>> search(String query);
  ...
  Future<Either<Failure, List<StatisticsEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<StatisticsEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, StatisticsEntity>> loadWithRelationships(StatisticsEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(StatisticsEntity entity, {List<dynamic>? childEntities});
