...
/// Repository interface for PomodoroSession entities following Clean Architecture principles.
///
...
abstract class PomodoroSessionRepository {
  ...
  /// Creates a new PomodoroSession entity in the data source.
  ///
  /// [entity] The PomodoroSession entity to create
  /// Returns Either<Failure, Entity> - Right with created entity (including generated ID) or Left with failure
  Future<Either<Failure, PomodoroSessionEntity>> create(PomodoroSessionEntity entity);

  /// Retrieves a PomodoroSession entity by its unique identifier.
  ///
  /// [id] The unique identifier of the entity
  /// Returns Either<Failure, Entity?> - Right with entity if found (null if not found) or Left with failure
  Future<Either<Failure, PomodoroSessionEntity?>> getById(int id);

  /// Retrieves all PomodoroSession entities from the data source.
  ///
  /// Returns Either<Failure, List<Entity>> - Right with list of entities (empty if none found) or Left with failure
  Future<Either<Failure, List<PomodoroSessionEntity>>> getAll();

  /// Updates an existing PomodoroSession entity in the data source.
  ///
  /// [entity] The PomodoroSession entity with updated data
  /// Returns Either<Failure, Entity> - Right with updated entity or Left with failure
  Future<Either<Failure, PomodoroSessionEntity>> update(PomodoroSessionEntity entity);

  /// Deletes a PomodoroSession entity by its unique identifier.
  ///
  ...
  Future<Either<Failure, List<PomodoroSessionEntity>>> getByField(String fieldName, dynamic value);

  /// Searches entities using a text query across searchable fields.
  ///
  /// [query] The search query string
  /// Returns Either<Failure, List<Entity>> - Right with matching entities (empty if none found) or Left with failure
  Future<Either<Failure, List<PomodoroSessionEntity>>> search(String query);
  ...
  Future<Either<Failure, List<PomodoroSessionEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<PomodoroSessionEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, PomodoroSessionEntity>> loadWithRelationships(PomodoroSessionEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(PomodoroSessionEntity entity, {List<dynamic>? childEntities});
