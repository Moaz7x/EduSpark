...
/// Repository interface for Category entities following Clean Architecture principles.
///
...
abstract class CategoryRepository {
  ...
  /// Creates a new Category entity in the data source.
  ///
  ...
  Future<Either<Failure, CategoryEntity?>> getById(int id);

  /// Retrieves all Category entities from the data source.
  ///
  ...
  /// Updates an existing Category entity in the data source.
  ///
  /// [entity] The Category entity with updated data
  ...
  Future<Either<Failure, List<CategoryEntity>>> getByField(String fieldName, dynamic value);
  ...
  Future<Either<Failure, List<CategoryEntity>>> getPaginated(int page, int limit);
  ...
  Future<Either<Failure, List<CategoryEntity>>> getFiltered(Map<String, dynamic> filters);
  ...
  Future<Either<Failure, CategoryEntity>> loadWithRelationships(CategoryEntity entity);
  ...
  Future<Either<Failure, bool>> saveWithRelationships(CategoryEntity entity, {List<dynamic>? childEntities});
