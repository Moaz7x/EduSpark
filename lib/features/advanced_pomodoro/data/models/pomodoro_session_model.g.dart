...
const PomodoroSessionModelSchema = CollectionSchema(
  ...
  links: {
    r'task': LinkSchema(
      id: -5607897038601594402,
      name: r'task',
      target: r'TaskModel',
      single: true,
    ),
    r'breaksessions': LinkSchema(
      id: 7616454121855022386,
      name: r'breaksessions',
      target: r'BreakSessionModel',
      single: false,
      linkName: r'pomodoroSession',
    )
  },
  embeddedSchemas: {},
...
List<IsarLinkBase<dynamic>> _pomodoroSessionModelGetLinks(
    PomodoroSessionModel object) {
  return [object.task, object.breaksessions];
}

void _pomodoroSessionModelAttach(
    IsarCollection<dynamic> col, Id id, PomodoroSessionModel object) {
  object.id = id;
  object.task.attach(col, col.isar.collection<TaskModel>(), r'task', id);
  object.breaksessions.attach(
      col, col.isar.collection<BreakSessionModel>(), r'breaksessions', id);
}
...
extension PomodoroSessionModelQueryWhere
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhereClause>
      endTimeEqualTo(DateTime? endTime) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'endTime',
        value: [endTime],
...
extension PomodoroSessionModelQueryLinks on QueryBuilder<PomodoroSessionModel,
    PomodoroSessionModel, QFilterCondition> {
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> task(FilterQuery<TaskModel> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> taskIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessions(FilterQuery<BreakSessionModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'breaksessions');
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'breaksessions', length, true, length, true);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'breaksessions', 0, true, 0, true);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'breaksessions', 0, false, 999999, true);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'breaksessions', 0, true, length, include);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'breaksessions', length, include, 999999, true);
    });
  }

  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> breaksessionsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'breaksessions', lower, includeLower, upper, includeUpper);
    });
  }
}
